...
class LoginPageBusinessEmail extends StatefulWidget {
  const LoginPageBusinessEmail({super.key});

  @override
  _LoginPageBusinessEmailState createState() => _LoginPageBusinessEmailState();
}

class _LoginPageBusinessEmailState extends State<LoginPageBusinessEmail> {
  ...
  Future<void> _login() async {
    try {
      ...
      if (email.isNotEmpty && password.isNotEmpty) {
        ...
        var url = Uri.parse('http://192.168.1.3:8080/validateBusinessAccountCredentials');
        ...
        if (response.statusCode == 200) {
          ...
          ScaffoldMessenger.of(context).showSnackBar(
            const SnackBar(content: Text('Email & Password Verified Successfully!')),
          );
        } else {
          // Handle error
          ScaffoldMessenger.of(context).showSnackBar(
            const SnackBar(content: Text('Failed to validate email or password!')),
          );
        }
      } else {
